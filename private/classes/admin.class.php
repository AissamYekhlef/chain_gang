...
class Admin extends DatabaseObject {
    ...
    protected function update() {
        if($_SESSION['admin_id'] == 1 || $this->id == $_SESSION['admin_id']) { //$session->id;
            if($this->password != ''){
                // validate password
                $this->set_hashed_password();
            } else {
            ...
            $this->errors[] = "You are Unauthorized.";
        }
    }
    ...
    public function verify_password($password){
        return password_verify($password, $this->hashed_password); // php function
    }
}
